...
public class DeleteGuideStepDefinitions {
	...
	/**
	 * Method containing the steps to be executed when setting up the divesafe
	 * system instance for the guide deletion tests
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 * @param dataTable Datatable specifying the information with which to setup the
	 *                  divesafe system instance
	 */
	@Given("the following DiveSafe system exists: \\(p12)")
	public void the_following_dive_safe_system_exists_p12(io.cucumber.datatable.DataTable dataTable) {
		...
		diveSafe.setPriceOfGuidePerDay(Integer.parseInt(exDiveSafe.get(0).get("priceOfGuidePerDay")));
	}

	/**
	 * Method used to instantiate the guides in the divesafe system used in the
	 * gherkin test for guide deletion
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 * @param dataTable Datatable specifying the guides to be added to the divesafe
	 *                  system instance
	 */
	...
	public void the_following_guides_exist_in_the_system_p12(io.cucumber.datatable.DataTable dataTable) {
		...
		for (Map<String, String> g : guideList) {
			diveSafe.addGuide(g.get("email"), g.get("password"), g.get("name"), g.get("emergencyContact"));
		}
	}

	/**
	 * Method used to instantiate the members in the divesafe system used in the
	 * gherkin test for guide deletion
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 * @param dataTable Datatable specifying the members to be added to the divesafe
	 *                  system instance
	 */
	...
	public void the_following_members_exist_in_the_system_p12(io.cucumber.datatable.DataTable dataTable) {
		...
		for (Map<String, String> m : memberList) {
			diveSafe.addMember(m.get("email"), m.get("password"), m.get("name"), m.get("emergencyContact"),
					Integer.parseInt(m.get("numDays")), Boolean.parseBoolean(m.get("guideRequired")),
					Boolean.parseBoolean(m.get("hotelRequired")));
		}
	}

	/**
	 * Method called by the gherkin guide deletion test to interact with the
	 * controller api under test. The method deletes a specified guide through a
	...
	/**
	 * Method used to check that the state of the model is exactly what is expected
	 * from the call to the controller method used in previous test steps. Here, we
	 * make sure the specified guide does not exist in the system
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 * @param string Email of the guide which should not exist in the divesafe
	 *               system instance
	 */
	 ...
	 * Method used to check that the state of the model is exactly what is expected
	 * from the call to the controller method used in previous test steps. Here, we
	 * make sure the amount of guides in the system is the same as the number
	 * specified
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 * @param string Expected number of guides in the divesafe system instance in
	 ...
	 * Method used to check that the state of the model is exactly what is expected
	 * from the call to the controller method used in previous test steps. Here, we
	 * make sure the specified member exists in the system
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 ...
	 * Method used to check that the state of the model is exactly what is expected
	 * from the call to the controller method used in previous test steps. Here, we
	 * make sure the number of guides in the system is equal to the Integer
	 * specified
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	 * @param int1 Expected number of guides in the divesafe system instance in the
	 *             form of an Integer
	 */
	...
	/**
	 * Helper method used to find a guide of the divesafe system from its email
	 * address
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
	...
	/**
	 * Helper method used to find a member of the divesafe system from its email
	 * address
	 *
	 * @author C�dric Barr�, Theo Ghanem, Zachary Godden, Chris Hatoum, Habib
	 *         Jarweh, Philippe Sarouphim Hochar
