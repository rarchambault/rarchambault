...
public class RegisterMemberStepDefinitions {
	...
	public void the_following_guides_exist_in_the_system_p9(io.cucumber.datatable.DataTable dataTable) {
		...
		for (int i = 0; i < rows.size(); i++) {
			...
			new Guide(email, rows.get(i).get("password"), rows.get(i).get("name"), rows.get(i).get("emergencyContact"),
					diveSafe);
		}
	}
	...
	public void a_new_member_attempts_to_register_with_and_p9(String email, String password, String name,
			String emergencyContact, String strNumDays, String strItems, String strItemQuantities,
			String strGuideRequired, String strHotelRequired) {
		...
		error = MemberController.registerMember(email, password, name, emergencyContact, numDays, guideRequired,
				hotelRequired, items, itemQuantities);
	}
	...
	public void a_new_member_account_shall_exist_with_and_p9(String email, String password, String name,
			String emergencyContact, String numDays, String items, String requestedQuantities, String guideRequired,
