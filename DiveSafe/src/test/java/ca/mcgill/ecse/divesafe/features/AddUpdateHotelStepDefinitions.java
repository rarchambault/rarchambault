...
public class AddUpdateHotelStepDefinitions {
	...
	/**
	 * This method create Hotel instances in diveSafe to construct environment for
	 * testing.
	 *
	 * @author Ziyue Wang
	 */
	...
	public void the_following_hotels_exist_in_the_system_p13(io.cucumber.datatable.DataTable dataTable) {
		...
		for (Map<String, String> columns : rows) {
			if (Hotel.getWithName(columns.get("name")) == null) {
				...
				diveSafe.addHotel(columns.get("name"), columns.get("address"), Integer.parseInt(columns.get("nrStars")),
						type);
			}
		}
	}
	...
	public void the_admin_attempts_to_add_a_new_hotel_to_the_system_with_and_p13(String name, String address,
			String numStars, String type) {
		callController(HotelController.addHotel(name, address, Integer.parseInt(numStars), type));
	}

	/**
	 * This method asserts new hotel has been succesfully added to diveSafe and find
	 * corresponding. hotel instance by its name, validate with its name, address
	 * rating params
	 *
	...
	public void the_hotel_with_and_shall_now_exist_in_the_system_p13(String name, String address, String numStars,
			String type) {
	...
	/**
	 * This method make sure the hotel is linked to divesafe by validating hotel
	 * numbers in divesafe.
	 *
	 * @author Ziyue Wang
	 */
	...
	/**
	 * This method asserts that new hotel not successfully added are not in divesafe
	 * and old hotel still exists.
	 *
	...
	public void the_admin_attempts_to_update_hotel_with_in_the_system_to_have_a_and_p13(String oldName, String newName,
			String newAddress, String newRating, String type) {

		callController(HotelController.updateHotel(oldName, newName, newAddress, Integer.parseInt(newRating), type));
	}
	...
	public void the_hotel_will_be_updated_to_have_a_and_p13(String newName, String newAddress, String newRating,
			String newType) {
	...
	public void the_hotel_will_keep_its_and_p13(String oldName, String oldAddress, String oldRating, String oldType) {
