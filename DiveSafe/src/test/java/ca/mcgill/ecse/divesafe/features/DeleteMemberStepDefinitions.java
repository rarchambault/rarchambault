...
public class DeleteMemberStepDefinitions {
	 ...
	 * @param dataTable the table containing the diveSafe numDays, startDate, and
	 *                  priceOfGuidePerDay attributes
	 */
	@Given("the following DiveSafe system exists: \\(p14)")
	public void the_following_dive_safe_system_exists_p14(io.cucumber.datatable.DataTable dataTable) {
	 ...
	 * @author: Hongfei Liu, Zihan Zhang, Matt MacDonald, Ryan Reszetnik, Sabrina
	 *          Mansour, Sehr Moosabhoy
	 * @param dataTable table containing the equipment that we need to instantiate
	 *                  in our system
	 */
	@Given("the following equipment exists in the system: \\(p14)")
	public void the_following_equipment_exists_in_the_system_p14(io.cucumber.datatable.DataTable dataTable) {
	 ...
	 * @author: Hongfei Liu, Zihan Zhang, Matt MacDonald, Ryan Reszetnik, Sabrina
	 *          Mansour, Sehr Moosabhoy
	 * @param dataTable the table containing the equipmentBundles that we need to
	 *                  instantiate in our system
	 */
	@Given("the following equipment bundles exist in the system: \\(p14)")
	public void the_following_equipment_bundles_exist_in_the_system_p14(io.cucumber.datatable.DataTable dataTable) {
	 ...
	 * @author: Hongfei Liu, Zihan Zhang, Matt MacDonald, Ryan Reszetnik, Sabrina
	 *          Mansour, Sehr Moosabhoy
	 * @param dataTable the table containing the Members that we need to instantiate
	 *                  in our system
	 */
	@Given("the following members exist in the system: \\(p14)")
	public void the_following_members_exist_in_the_system_p14(io.cucumber.datatable.DataTable dataTable) {
		List<Map<String, String>> rows = dataTable.asMaps();

		for (Map<String, String> columns : rows) {

			Member m = diveSafe.addMember(columns.get("email"), columns.get("password"), columns.get("name"),
			...
			for (int i = 0; i < itemStrings.length; i++) {
				m.addItemBooking(Integer.parseInt(itemQuantity[i]), diveSafe, Item.getWithName(itemStrings[i]));
			}
		}
	 ...
	 * @author: Hongfei Liu, Zihan Zhang, Matt MacDonald, Ryan Reszetnik, Sabrina
	 *          Mansour, Sehr Moosabhoy
	 * @param dataTable the table containing the Guides that we need to instantiate
	 *                  in our system
	 */
	@Given("the following guides exist in the system: \\(p14)")
	public void the_following_guides_exist_in_the_system_p14(io.cucumber.datatable.DataTable dataTable) {
		List<Map<String, String>> data = dataTable.asMaps();
		for (Map<String, String> r : data) {

			diveSafe.addGuide(r.get("email"), r.get("password"), r.get("name"), r.get("emergencyContact"));
		}
	}
	 ...
	 * @author: Hongfei Liu, Zihan Zhang, Matt MacDonald, Ryan Reszetnik, Sabrina
	 *          Mansour, Sehr Moosabhoy
	 * @param string the email of the Member account that the member is trying to
	 *               delete
	 */
	 ...
	 * @author: Hongfei Liu, Zihan Zhang, Matt MacDonald, Ryan Reszetnik, Sabrina
	 *          Mansour, Sehr Moosabhoy
	 * @param string the email of the guide account that should still exist in the
	 *               system
	 */
