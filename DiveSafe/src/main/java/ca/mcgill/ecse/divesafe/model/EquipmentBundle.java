...
// line 92 "../../../../../DiveSafe.ump"
// line 209 "../../../../../DiveSafe.ump"
	...
	public EquipmentBundle(String aName, int aDiscount, DiveSafe aDiveSafe) {
		...
		if (!didAddDiveSafe) {
			throw new RuntimeException(
					"Unable to create bundle due to diveSafe. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
