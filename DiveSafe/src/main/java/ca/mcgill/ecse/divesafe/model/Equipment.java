...
public class Equipment extends Item {
	...
	public Equipment(String aName, int aWeight, int aPricePerDay, DiveSafe aDiveSafe) {
		...
		if (!didAddDiveSafe) {
			throw new RuntimeException(
					"Unable to create equipment due to diveSafe. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
	...
	public String toString() {
		return super.toString() + "[" + "weight" + ":" + getWeight() + "," + "pricePerDay" + ":" + getPricePerDay()
