...
public class Hotel {
	...
	public Hotel(String aName, String aAddress, int aRating, HotelType aType, DiveSafe aDiveSafe) {
		...
		if (!didAddDiveSafe) {
			throw new RuntimeException(
					"Unable to create hotel due to diveSafe. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
	...
	public String toString() {
		return super.toString() + "[" + "name" + ":" + getName() + "," + "address" + ":" + getAddress() + "," + "rating"
				+ ":" + getRating() + "]" + System.getProperties().getProperty("line.separator") + "  " + "type" + "="
