...
public class MemberController {
	 ...
	 */
	public static String registerMember(String email, String password, String name, String emergencyContact, int nrDays,
		...
		Member member = diveSafe.addMember(email, password, name, emergencyContact, nrDays, guideRequired,
				hotelRequired);
	 ...
	 * @throws InvalidInputException
	 */
	public static String updateMember(String email, String newPassword, String newName, String newEmergencyContact,
			int newNrDays, boolean newGuideRequired, boolean newHotelRequired, List<String> newItemNames,
			List<Integer> newItemQuantities) {
		...
		for (int i = 0; i < newItemNames.size(); i++) {
			diveSafe.addItemBooking(newItemQuantities.get(i), member, Item.getWithName(newItemNames.get(i)));
		}
	...
	public static Member getWithEmail(String email) {
		return Member.getWithEmail(email);
	}
	...
	private static String checkCommonConditions(String password, String name, String emergencyContact, int nrDays,
