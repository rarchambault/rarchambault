...
<template>
    <section id="hero"> <!-- Big Hero Image to grab attention--> 
        <v-parallax dark src="@/assets/MarwanMuseum.png" height="750"> <!-- Image getter and properties--> 
            <v-row align="center" justify="center"> <!-- alignment and justification--> 
                <v-col cols="10">
                    <v-row align="center" justify="center">
                        <v-col cols="12" md="6" xl="8">
                            <v-app-bar app elevation="4"> <!-- Main Nav Bar--> 
                                <v-toolbar-title>Welcome to Marwan's Fun House. Come Inside, it's fun inside
                                    :)</v-toolbar-title>
                                <v-spacer></v-spacer>
                ...
                <v-col cols="12">
                    <v-row align="center" justify="space-around">
                        <v-col cols="12" class="text-center">
                            <h1 class="font-weight-light display-2"> Marwan's Fun House!</h1> <!-- Main heading-->
                            ...
                            <div class="row pb-0">
                                <div class="text-center">
                                    <h2 class="display-1 white">
                                        ...
                                        <br />
                                        <br />
                                        Bringing the World Great Art since 1969
                                    </h2>
                                </div>
                        ...
                        <div class="container center center">
                            <div class="row pb-0">
                                <div class="text-center">
                                    <h3 class="display-1 white">
                                        <br />
                                        Enriching Lives, Expanding Minds
                                    </h3>
                                </div>
    ...
    data() {
        return {
            ...
            features: [ //data for cards
                {
                    img: require("@/assets/img/art1.png"),
                    title: "Our Collections and Exhibitions",
                    text: "Come Explore our World Class Collections of Artworks and Oddities",
                },
                {
                    img: require("@/assets/img/art3.png"),
                    title: "Virtual Tour",
                    text: "Come Explore our Museum from the comfort of your own home",
                },
                {
                    img: require("@/assets/img/art2.png"),
                    title: "Loans and Donations",
                    text: "Want to Donate to the museum? Want to Loan an item? We've got you!",
                },
            ],
        };
    },
...
#white {
    background-color: aliceblue;
    background: url('../assets/whiteart.png') no-repeat center center;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
    background-size: cover;
