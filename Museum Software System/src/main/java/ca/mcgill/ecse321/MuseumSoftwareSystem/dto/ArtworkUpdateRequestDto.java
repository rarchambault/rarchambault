...
public class ArtworkUpdateRequestDto {
	...
	public ArtworkUpdateRequestDto(int aMuseumId, int aRoomId, String aName, double aLoanFee, boolean aIsInMuseum,
	...
	public ArtworkUpdateRequestDto(Artwork artwork) {
	...
	public ArtworkUpdateRequestDto() {
	}
